...
use signaturebuild::function::FunctionGUID;
...
impl Command for ApplySignatureFile {
    fn action(&self, view: &BinaryView) {
        ...
        let Some(data) = signaturebuild::Data::from_bytes(&data) else {
        ...
        let data_functions: HashMap<FunctionGUID, Vec<signaturebuild::function::Function>> = data
            .functions
            .into_iter()
