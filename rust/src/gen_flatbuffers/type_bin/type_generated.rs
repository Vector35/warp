...
impl<'a> Type<'a> {
  ...
  pub fn alignment(&self) -> u16 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u16>(Type::VT_ALIGNMENT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn modifiers(&self) -> TypeModifiers {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<TypeModifiers>(Type::VT_MODIFIERS, Some(Default::default())).unwrap()}
  }
  #[inline]
  pub fn metadata(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TypeMetadata<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TypeMetadata>>>>(Type::VT_METADATA, None)}
  }
  #[inline]
  pub fn ancestors(&self) -> Option<flatbuffers::Vector<'a, TypeGUID>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, TypeGUID>>>(Type::VT_ANCESTORS, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for Type<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<TypeModifiers>("modifiers", Self::VT_MODIFIERS, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<TypeMetadata>>>>("metadata", Self::VT_METADATA, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, TypeGUID>>>("ancestors", Self::VT_ANCESTORS, false)?
     .finish();
    Ok(())
  }
}
pub struct TypeArgs<'a> {
    ...
    pub metadata: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TypeMetadata<'a>>>>>,
    pub ancestors: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, TypeGUID>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TypeBuilder<'a, 'b, A> {
  ...
  pub fn add_alignment(&mut self, alignment: u16) {
    self.fbb_.push_slot::<u16>(Type::VT_ALIGNMENT, alignment, 0);
  }
  #[inline]
  pub fn add_modifiers(&mut self, modifiers: TypeModifiers) {
    self.fbb_.push_slot::<TypeModifiers>(Type::VT_MODIFIERS, modifiers, Default::default());
  }
  #[inline]
  pub fn add_metadata(&mut self, metadata: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<TypeMetadata<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Type::VT_METADATA, metadata);
  }
  #[inline]
  pub fn add_ancestors(&mut self, ancestors: flatbuffers::WIPOffset<flatbuffers::Vector<'b , TypeGUID>>) {
