...
use crate::prelude::TypeModifierClass;
use crate::r#type::class::TypeClass;
use crate::r#type::modifier::TypeModifier;
use crate::Build;
...
pub struct Type {
    ...
    pub confidence: u8,
    // TODO: Flatten out modififers to directly just use TypeModifier (see is_const)
